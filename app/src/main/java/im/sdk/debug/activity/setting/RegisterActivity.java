...
public class RegisterActivity extends Activity {
    ...
    private void initData() {
        getRegisterResult = new SubscriberOnNextListener<String>() {
            @Override
                ...
                JMessageClient.register(userName, password, new BasicCallback() {
                    ...
                    public void gotResult(int responseCode, String registerDesc) {
                        if (responseCode == 0) {
                            ...
                            HttpMethods.getInstance().getRegisterResult(new ProgressSubscriber(getRegisterResult, RegisterActivity.this,true), userName, password);
