    ...
    public void onEvent(NotificationClickEvent notificationClickEvent) {
        ...
        if (msg != null) {
            ...
            if (type == ConversationType.single) {
                ...
                notificationIntent.putExtra(IMDebugApplication.TARGET_ID, targetId);
                notificationIntent.putExtra(IMDebugApplication.TARGET_APP_KEY, appKey);
                Log.d("Notification", "msg.fromAppKey() " + appKey);
            } else {
                conv = JMessageClient.getGroupConversation(Long.parseLong(targetId));
                notificationIntent.putExtra(IMDebugApplication.GROUP_ID, Long.parseLong(targetId));
            }
