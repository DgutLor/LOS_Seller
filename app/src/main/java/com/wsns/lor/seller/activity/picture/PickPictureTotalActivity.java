...
import com.wsns.lor.seller.adapter.AlbumListAdapter;
import com.wsns.lor.seller.application.IMDebugApplication;
import com.wsns.lor.seller.R;
import com.wsns.lor.seller.chatting.entity.ImageBean;
import com.wsns.lor.seller.utils.SortPictureList;
...
//		mGroupGridView = (GridView) findViewById(R.id.pick_picture_total_grid_view);
        ...
        mListView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                startActivityForResult(mIntent, IMDebugApplication.REQUEST_CODE_SELECT_ALBUM);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == IMDebugApplication.RESULT_CODE_SELECT_ALBUM) {
            setResult(IMDebugApplication.RESULT_CODE_SELECT_PICTURE, data);
            finish();
        }
    }
