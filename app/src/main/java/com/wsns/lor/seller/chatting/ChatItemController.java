...
import com.wsns.lor.seller.activity.picture.BrowserViewPagerActivity;
import com.wsns.lor.seller.application.IMDebugApplication;
import com.wsns.lor.seller.chatting.MsgListAdapter.ViewHolder;
import com.wsns.lor.seller.chatting.entity.FileType;
            ...
            switch (msg.getContentType()) {
                ...
                case image:
                    if (holder.picture != null && v.getId() == holder.picture.getId()) {
                        ...
                        intent.putExtra(IMDebugApplication.TARGET_ID, mConv.getTargetId());
                        intent.putExtra("msgId", msg.getId());
                        if (mConv.getType() == ConversationType.group) {
                            GroupInfo groupInfo = (GroupInfo) mConv.getTargetInfo();
                            intent.putExtra(IMDebugApplication.GROUP_ID, groupInfo.getGroupID());
                        }
                        intent.putExtra(IMDebugApplication.TARGET_APP_KEY, mConv.getTargetAppKey());
                        intent.putExtra("msgCount", mMsgList.size());
                        intent.putIntegerArrayListExtra(IMDebugApplication.MsgIDs, getImgMsgIDList());
                ...
                case file:
                    ...
                    if (!TextUtils.isEmpty(content.getLocalPath())) {
                        ...
                        if (msg.getDirect() == MessageDirect.send) {
                            ...
                            final String newPath = IMDebugApplication.FILE_DIR + fileName;
