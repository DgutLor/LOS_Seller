...
import com.wsns.lor.seller.receiver.NotificationClickEventReceiver;
...
public class IMDebugApplication extends MultiDexApplication {
    ...
    public static final String LOR_BUYER_IM_KEY = "722c6d173c859f33536f05e1";
...
//        JPushInterface.init(this);     		// 初始化 JPush
    ...
    public static void setPicturePath(String appKey) {
        if (!SharePreferenceManager.getCachedAppKey().equals(appKey)) {
            ...
            PICTURE_DIR = "sdcard/LOR_Seller/pictures/" + appKey + "/";
        }
    }
}
