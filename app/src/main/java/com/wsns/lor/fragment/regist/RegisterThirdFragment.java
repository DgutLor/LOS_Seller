...
public class RegisterThirdFragment extends Fragment{
     ...
     * @param password   密码
     */
    public void getRegisterResult(Subscriber<DataAndCodeBean<User>> subscriber, String account, String password) {
    ...
    private class HttpResultFunc<User> implements Func1<DataAndCodeBean<User>, User> {
